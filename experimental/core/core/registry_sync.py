...
class GitHubRegistrySync:
    ...
    def _do_push(self, algorithm: Any, validation_result: Any, token: str) -> dict[str, Any]:
    ...
    def _build_metadata(self, algorithm: Any, validation_result: Any) -> dict[str, Any]:
        return {
            "name": algorithm.name,
            "version": "1.0.0",
            "status": "beta",
    ...
    def _build_pr_body(self, algorithm: Any, validation_result: Any) -> str:
        return f"""
