...
class VectorKnowledgeBase:
    ...
    def store(self, context: dict, algorithm_names: list[str], metrics: dict) -> None:
        record = {
            "timestamp": time.time(),
            "context": {
    ...
    def penalize(self, algorithm_name: str, context: dict) -> None:
        penalty_record = {
            "timestamp": time.time(),
    ...
    def discount_old_records(self, factor: float = 0.5) -> None:
    ...
    def merge(self, global_knowledge: dict) -> None:
        """
