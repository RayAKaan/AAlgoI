...
class ReplayBuffer:
    ...
    def push(self, state: np.ndarray, action: int, reward: float,
             next_state: np.ndarray, done: bool, info: dict[str, Any] | None = None) -> None:
        self.buffer.append({
...
class EpisodeBuffer:
    ...
    def push(self, state: np.ndarray, action: int, reward: float,
             done: bool, log_prob: float | None = None, value: float | None = None) -> None:
...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def push(self, state: np.ndarray, action: int, reward: float, next_state: np.ndarray, done: bool, info: dict[str, Any] | None = None, priority: float | None = None) -> None:
