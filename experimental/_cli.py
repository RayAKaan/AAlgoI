...
def _cmd_solve(args: argparse.Namespace, mind_path: Path) -> None:
...
def _cmd_checkpoint(args: argparse.Namespace, mind_path: Path) -> None:
    from aalgoi._core import Mind
    mind = Mind(mind_path)
...
def _cmd_rollback(args: argparse.Namespace, mind_path: Path) -> None:
    from aalgoi._core import Mind
    mind = Mind(mind_path)
